...
//	1.2 In case of being removed, the field in PatchD must be 'nil' and must exists in originalD.
//	1.3 An empty patch data will not modify the original data stored in the DB.
// 2- New fields can also be added, whenever the new field does not exists in the originalD and it is not 'nil' in PatchD.
